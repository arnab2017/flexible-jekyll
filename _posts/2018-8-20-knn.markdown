...
1. Euclidean Distance, D(X,Y)=√(∑_(i=1)^n▒〖(X_i-Y_i)〗^2 )  
Or 
2. Euclidean Distance =√(〖(X_H- H_I)〗^2+〖(X_w- W)〗^2 ), here XH stands for Observed value and HI stands for Actual value.
Or 
3. Euclidean Distance [ (x,y), (a,b) ] = √((x-a)^2+ (x-b)^2 ) 
...
Euclidean Distance = d(X, P) = √((x1-p1)^2+〖(x2-p2)〗^2 )
